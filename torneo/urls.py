...
informacion_torneo, equipos_torneo, borrar_equipo_torneo, inscribir_equipo
...
urlpatterns = [
    ...
    path('<int:torneo_id>/equipos/inscribir/<int:equipo_id>/', inscribir_equipo, name='inscribir_equipo'),
]